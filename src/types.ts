...
export interface Translations {
  ...
  bn?: TranslationItem;
  or?: TranslationItem;
  [key: string]: TranslationItem | undefined;
}
...
export const ALL_SUPPORTED_LANGUAGES: SupportedLanguage[] = [
  ...
  { code: 'ml', label: 'Malayalam', nativeName: 'മലയാളം', speechCode: 'ml-IN' },
  { code: 'mr', label: 'Marathi', nativeName: 'मराठी', speechCode: 'mr-IN' },
  { code: 'bn', label: 'Bengali', nativeName: 'বাংলা', speechCode: 'bn-IN' },
  { code: 'or', label: 'Odia', nativeName: 'ଓଡ଼ିଆ', speechCode: 'or-IN' }
];
...
export interface ChatMessage {
  ...
  translations: Record<string, string>; // cached translations per language code
...
export interface Order {
  ...
  expectedDeliveryDate: string; // e.g. "17 Sep 2026"
